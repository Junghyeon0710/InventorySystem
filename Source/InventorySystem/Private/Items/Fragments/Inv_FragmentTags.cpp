#include "InventorySystem/Public/Items/Fragments/Inv_FragmentTags.h"
...
namespace FragmentTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(PrimaryStatFragmentFragment, "FragmentTags.PrimaryStatFragmentFragment")
	...
	namespace StatMod
	{
		UE_DEFINE_GAMEPLAY_TAG(StaMod_1, "FragmentTags.StaMod.1")
		UE_DEFINE_GAMEPLAY_TAG(StaMod_2, "FragmentTags.StaMod.2")
		UE_DEFINE_GAMEPLAY_TAG(StaMod_3, "FragmentTags.StaMod.3")
